...
export declare type JSONRPCMessage<T> = JSONRPCNotification<T> | JSONRPCResponse<T>;
export declare type EventCallback<T = Record<string, unknown>> = (event?: T) => void | Promise<void>;
