...
export declare const locateUppercaseCharacters: (passphrase: string) => readonly number[];
export declare const locateConsecutiveWhitespaces: (passphrase: string) => readonly number[];
export declare const getPassphraseValidationErrors: (passphrase: string, wordlists?: readonly string[] | undefined, expectedWords?: number) => readonly PassphraseError[];
export {};
